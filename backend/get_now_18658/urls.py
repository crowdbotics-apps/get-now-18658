"""get_now_18658 URL Configuration
...
admin.site.site_header = "Get Now"
admin.site.site_title = "Get Now Admin Portal"
admin.site.index_title = "Get Now Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Get Now API",
        default_version="v1",
        description="API documentation for Get Now App",
    ),
    public=True,
